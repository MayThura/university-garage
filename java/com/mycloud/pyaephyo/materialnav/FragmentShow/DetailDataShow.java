package com.mycloud.pyaephyo.materialnav.FragmentShow;
...
public class DetailDataShow extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new DetailDataFragment(), "Detail Info");
